...
from model.model import LongBert
import logging
import argparse
...
def init_train_env(args):
    ...
    if args.code_bert == 'longformer':
        model = LongBert(LongformerConfig(), args.code_bert, args.num_class)
    else:
        raise Exception("BERT type not found")
...
def get_train_args():
    ...
    parser.add_argument("--data_folder", default="../data/processed1.csv", type=str,
                        help="train data file")
    parser.add_argument("--test_data_folder", default="../data/test.csv", type=str,
                        help="test data file")
    parser.add_argument("--binary_type", default="API_CHANGE",
                        choices=["API_CHANGE","API_USAGE","CONCEPTUAL","DISCREPANCY","DOCUMENTATION","ERRORS","REVIEW"])
    parser.add_argument("--train_numbers", default=450, type=int,
    ...
    parser.add_argument("--per_gpu_train_batch_size", default=64,
                        type=int, help="Batch size per GPU/CPU for training.")
    parser.add_argument("--per_gpu_evalute_batch_size", default=64,
    ...
    parser.add_argument("--code_bert", default='allenai/longformer-base-4096',
                        choices=['microsoft/codebert-base','allenai/longformer-base-4096'])
    parser.add_argument(
